...
AddBook Admin test
    ...
    sleep  1s
    input text  name:name   Panchatantra
    sleep  1s
    input text  name:author  Vishnu Sharma
    sleep  1s
    input text  name:category   narrative literature
    sleep  1s
    input text  name:price  1299
    sleep  1s
    input text  name:publisher  Rupa & Co.
    sleep  1s
